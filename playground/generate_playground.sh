...
# nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpi/sales-gateway --api-id=sales-gateway --output-dir=sales-gateway  --setup-file=../etc/sales-mapi-setup.json
